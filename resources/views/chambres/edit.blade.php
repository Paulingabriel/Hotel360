    ...
    <div class="form-section mb-3">
        ...
        <form action="" method="post">
                ...
                <div class="form-group mb-3">
                    <input type="hidden" name="id" value="{{$chambres->id}}">
                </div>
                <div class="row w-100">
                    <div class="col-md-6 col-xl-5  mb-4">
                        <label for="date" class="label col-md-12 mb-2">Numéro de chambre</label>
                        <input type="number" class="border border-2 form-control ps-0 form-control-line @error('num') is-invalid @enderror" name="num" value="{{$chambres->num}}">
                ...
                <div class="row w-100">
                    <div class="col-md-6 col-xl-5  mb-4">
                        ...
                        <select class="border border-2 form-control form-select shadow-none form-control-line" name="etage_id">
