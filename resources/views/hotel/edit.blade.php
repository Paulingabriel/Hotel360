            ...
            @csrf
                <div class="row w-100">
                    <div class="col-md-6 col-xl-5  mb-4">
                        ...
                        <input type="text" class="border border-2 form-control ps-0 form-control-line @error('nom') is-invalid @enderror" name="nom" value="{{ $hotel->nom }}">
                        <span class="text-danger">{{ $errors->first('nom') }}</span>
                    </div>
                    <div class="col-md-6 col-xl-5 offset-xl-2 mb-4">
                        <label for="date" class="label col-md-12 mb-2">Email</label>
                        <input type="email" class="border border-2 form-control ps-0 form-control-line @error('email') is-invalid @enderror" name="email" value="{{ $hotel->email }}">
                ...
                <div class="row w-100">
                    ...
                    <div class="col-md-6 col-xl-5 offset-xl-2 mb-4">
                        ...
                        <input type="text" class="border border-2 form-control ps-0 form-control-line @error('adresse') is-invalid @enderror" name="adresse" value="{{ $hotel->adresse }}">
                ...
                <div class="row w-100">
                    <div class="col-md-6 col-xl-5 mb-4">
                        ...
                        <input type="number" class="border border-2 form-control ps-0 form-control-line @error('tel1') is-invalid @enderror" name="tel1" value="{{ $hotel->tel1 }}">
                        <span class="text-danger">{{ $errors->first('tel1') }}</span>
                    </div>
                    <div class="col-md-6 col-xl-5 offset-xl-2 mb-4">
                        <label for="date" class="label col-md-12 mb-2">Téléphone 2</label>
                        <input type="number" class="border border-2 form-control ps-0 form-control-line @error('tel2') is-invalid @enderror" name="tel2" value="{{ $hotel->tel2 }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6 col-xl-5 offset-xl-2 mb-4">
                        ...
                        <input type="text" class="border border-2 form-control ps-0 form-control-line @error('ville') is-invalid @enderror" name="ville" value="{{ $hotel->ville }}">
                ...
                <div class="row mb-4">
                    <div class="col-md-6 col-xl-5">
                        ...
                        <select class="border border-2 form-control form-select shadow-none form-control-line" name="devise">
                            <option value="{{$hotel->devise}}" selected>{{$hotel->devise}}</option>
