                    ...
                    @csrf
                        <div class="row">
                            <div class="col-md-6 col-xl-5 mb-4">
                                ...
                                <select class="border border-2 form-control form-select shadow-none form-control-line" id="client_id" name="client_id">
                            ...
                            <div class="col-md-6 col-xl-5 offset-xl-2 mb-4">
                                ...
                                <select class="border border-2 form-control form-select shadow-none form-control-line" id="salle_id" name="salle_id">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-5 mb-4">
                                ...
                                <input type="date" class="border border-2 form-control ps-0 form-control-line" id="dateres" name="dateres">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-5  mb-4">
                                ...
                                <input type="date" class="border border-2 form-control ps-0 form-control-line" id="datedebut" name="datedebut">
                                <span class="text-danger" id="datedebutError"></span>
                            </div>
                            <div class="col-md-6 col-xl-5  offset-xl-2 mb-4">
                                <label for="date" class="label col-md-12 mb-2">Au</label>
                                <input type="date" class="border border-2 form-control ps-0 form-control-line" id="datefin" name="datefin">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-xl-5 mb-4">
                                ...
                                <select class="border border-2 form-control form-select shadow-none form-control-line" id="salles_pr_id" name="salles_pr_id">
                            ...
                            <div class="col-md-6 col-xl-5 offset-xl-2 mb-4">
                                ...
                                <select class="border border-2 form-control form-select shadow-none form-control-line" id="salles_ps_id" name="salles_ps_id">
                                    <option value="" selected>------------</option>
