        ...
        <form action="" method="post" enctype="multipart/form-data">
            @csrf
                <div class="form-group mb-3">
                    <input type="hidden" name="id" value="{{$typessalles->id}}">
                </div>
                <div class="row w-100">
                    <div class="col-md-6 col-xl-5  mb-4">
                        <label for="date" class="label col-md-12 mb-2">Titre</label>
                        <input type="text" class="border border-2 form-control ps-0 form-control-line @error('titre') is-invalid @enderror" name="titre" value="{{$typessalles->titre}}">
                        <span class="text-danger">{{ $errors->first('titre') }}</span>
                    </div>
                    <div class="col-md-6 col-xl-5 offset-xl-2 mb-4">
                        <label for="date" class="label col-md-12 mb-2">Code</label>
                        <input type="text" class="border border-2 form-control ps-0 form-control-line @error('code') is-invalid @enderror" name="code" value="{{$typessalles->code}}">
                ...
                <div class="row w-100">
                    <div class="col-md-6 col-xl-5 mb-4">
                        ...
                        <input type="number" class="border border-2 form-control ps-0 form-control-line @error('min') is-invalid @enderror" name="min" value="{{$typessalles->min}}">
                        <span class="text-danger">{{ $errors->first('min') }}</span>
                    </div>
                    <div class="col-md-6 col-xl-5 offset-xl-2 mb-4">
                        <label for="date" class="label col-md-12 mb-2">Occupation maximale</label>
                        <input type="number" class="border border-2 form-control ps-0 form-control-line @error('min') is-invalid @enderror" name="max" value="{{$typessalles->max}}">
                        <span class="text-danger">{{ $errors->first('min') }}</span>
                    </div>
                </div>
                <div class="row w-100">
                    <div class="col-md-6 col-xl-5 mb-4">
                        ...
                        <input type="file" style="border-radius: 0!important; border: none!important;" class="border border-2 form-control ps-0 form-control-line" name="image" value="{{$typessalles->image}}">
                    </div>
                </div>
                <div class="row mb-4">
                    <div class="col-md-12">
                ...
                <div class="row w-100">
                    <div class="offset-xl-7 col-xl-5 mt-5">
                        <div class="btn-actions">
                            ...
                            <a href="{{route("typesChambres/edit", ['id' => $typessalles->id])}}">
