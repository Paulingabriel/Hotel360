        ...
        <div class="main-panel">
            <div class="main-content">
                <div class="content-wrapper">
                    <div class="row my-3">
                        <h4 class="border-bottom border-2 pb-2 mb-4" style="font-weight: 500;">Salles</h4>
                        <div class="col-md-12">
                    ...
                    <table id="example" class="table table-striped dt-responsive nowrap" style="width:100%">
                        ...
                        <thead>
                            <tr>
                                <td class="d-none">#</td>
                                <td>Numero de Salles</td>
                                <td>Salles</td>
                                <td>Types de Salles</td>
                                <td>Etage</td>
                                <td>Etat</td>
                                <td>Ajoutée</td>
                                <td>Actions</td>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $salle->active == 1 ? 'Active' : 'inActive' }}</td>
